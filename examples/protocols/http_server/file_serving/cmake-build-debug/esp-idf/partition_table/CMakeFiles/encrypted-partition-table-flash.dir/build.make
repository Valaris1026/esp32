...
esp-idf/partition_table/CMakeFiles/encrypted-partition-table-flash:
	cd /d D:\Testspace\esp32\examples\protocols\http_server\file_serving\cmake-build-debug\esp-idf\partition_table && "C:\MySoft\IDE\CLion 2022.3.3\bin\cmake\win\x64\bin\cmake.exe" -E echo "Error: The target encrypted-partition-table-flash requires"
	cd /d D:\Testspace\esp32\examples\protocols\http_server\file_serving\cmake-build-debug\esp-idf\partition_table && "C:\MySoft\IDE\CLion 2022.3.3\bin\cmake\win\x64\bin\cmake.exe" -E echo "CONFIG_SECURE_FLASH_ENCRYPTION_MODE_DEVELOPMENT to be enabled."
	cd /d D:\Testspace\esp32\examples\protocols\http_server\file_serving\cmake-build-debug\esp-idf\partition_table && "C:\MySoft\IDE\CLion 2022.3.3\bin\cmake\win\x64\bin\cmake.exe" -E env "FAIL_MESSAGE=Failed executing target (see errors on lines above)" "C:/MySoft/IDE/CLion 2022.3.3/bin/cmake/win/x64/bin/cmake.exe" -P C:/Espressif/frameworks/esp-idf-v5.1.2/tools/cmake/scripts/fail.cmake
...
esp-idf/partition_table/CMakeFiles/encrypted-partition-table-flash.dir/clean:
	cd /d D:\Testspace\esp32\examples\protocols\http_server\file_serving\cmake-build-debug\esp-idf\partition_table && $(CMAKE_COMMAND) -P CMakeFiles\encrypted-partition-table-flash.dir\cmake_clean.cmake
