...
.bin_timestamp: bootloader.elf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=D:\Testspace\esp32\examples\protocols\esp_http_client\cmake-build-debug\bootloader\CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating binary image from built executable"
	python C:/Espressif/frameworks/esp-idf-v5.1.2/components/esptool_py/esptool/esptool.py --chip esp32s3 elf2image --flash_mode dio --flash_freq 80m --flash_size 2MB --min-rev-full 0 --max-rev-full 99 -o D:/Testspace/esp32/examples/protocols/esp_http_client/cmake-build-debug/bootloader/bootloader.bin D:/Testspace/esp32/examples/protocols/esp_http_client/cmake-build-debug/bootloader/bootloader.elf
	"C:\MySoft\IDE\CLion 2022.3.3\bin\cmake\win\x64\bin\cmake.exe" -E echo "Generated D:/Testspace/esp32/examples/protocols/esp_http_client/cmake-build-debug/bootloader/bootloader.bin"
	"C:\MySoft\IDE\CLion 2022.3.3\bin\cmake\win\x64\bin\cmake.exe" -E md5sum D:/Testspace/esp32/examples/protocols/esp_http_client/cmake-build-debug/bootloader/bootloader.bin > D:/Testspace/esp32/examples/protocols/esp_http_client/cmake-build-debug/bootloader/.bin_timestamp
